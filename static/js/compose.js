...
function insert_webex_video_call_details(details, target_textarea) {
    const meeting_number_text = i18n.t("Meeting number");
    const password_text = i18n.t("Password");
    const start_time_text = i18n.t("Meeting start time");
    const end_time_text = i18n.t("Meeting end time");
    ...
    $("body").on("click", ".video_link", (e) => {
        ...
        if (
            ...
            if (page_params.has_webex_token) {
                ...
                exports.webex_token_callbacks.set(key, make_webex_meeting);
                window.open(
